...
ggsave(
  ...
  paste0(results_path,"figures/relative_scen/all/x2030_sq_relative_map.png"),
...
## Fig. S4 Relative to SQ (Delta Delta) bar plots
...
# write data for dataverse
write_csv(fe_data %>% rowid_to_column("index"),
          "~/Library/CloudStorage/GoogleDrive-jepa88@gmail.com/My Drive/lenfest_mpa_project/data/01 spatial/gridded/fe_data_scen.csv")
...
**NOTE:** The code below is not inlcuded in the final version of the manuscript and has no relation with the final product.
