...
# Scenario: Best Case (regulation implemented)
...
# Scenario: Partial regulations 

*Requires SQ data*

## for conservation (reg_par_con)
...
ggsave(
       paste0(data_path,"spatial/compute_canada/rpc_scenario_map.png"),
       rpc_map)


```

## For fisheries (reg_par_pes)
